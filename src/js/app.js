App = {
  ...
  initContract: function () {
    $.getJSON('Claims.json', function (data) {
      ...
      if (stageGbl === 0 || stageGbl === undefined) {
  ...
  bindEvents: function () {
    ...
    $(document).on('click', '#claimBtn', function () {
      ...
      var claimDescription = $('#claimDesc').val();
  ...
  viewClaim: function () {
    ...
    App.contracts.vote.deployed().then(function (instance) {
      ...
      if (_idPolicyGbl != 0 && _idPolicyGbl != undefined && _idPolicyGbl != "") {
  ...
  viewVoucher: function () {
    ...
    App.contracts.vote.deployed().then(function (instance) {
      ...
      _idVoucherGbl = result.toString();
      if (_idVoucherGbl != 0 && _idVoucherGbl != undefined && _idVoucherGbl != "") {
        $("#voucherId").val(_idVoucherGbl);
      }
      if (result.receipt.status == '0x01')
        alert(" is registered successfully")
      else
  ...
  viewRepair: function () {
    ...
    App.contracts.vote.deployed().then(function (instance) {
      ...
      if (_amtRepairGbl != 0 && _amtRepairGbl != undefined && _amtRepairGbl != "") {
  ...
  viewExpert: function () {
    ...
    App.contracts.vote.deployed().then(function (instance) {
      ...
      _descExpertGbl = result.toString();

      if (_descExpertGbl != 0 && _descExpertGbl != undefined && _descExpertGbl != "") {
        $("#reqExpert").val(_descExpertGbl);
      }
